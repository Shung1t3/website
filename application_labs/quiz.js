...
function takeTest() {
    ...
    //to upper case is juseful here so you don't have to worry about capital letters
    console.log(points);
    response = prompt(q2, "");
...
//since it uses += it can just add i to the total instead of worrying about overwriting it.